...
// Sections for orange theme
import OrangeSection3 from '../components/orange/Section_3'
import OrangeMoments from '../components/orange/MomentsMovement'
import OrangeSection11 from '../components/orange/Section_11_11'

// Sections for green theme
import GreenSection3 from '../components/green/Section_3'
import GreenMoments from '../components/green/MomentsMovement'
...
import Footer from '../components/Footer'
 ...
 const Sections = [
    ...
    { section3: GreenSection3, moments: GreenMoments, section11: GreenSection11 }
  ]
    ...
    <div className='relative overflow-hidden cursor-default'>
      ...
      <div ref={containerRef}>
        <div className='bg-[#FE5E33] h-[100dvh] md:h-[95dvh] relative'
          style={{ backgroundColor: themeColors[selectedItem].primary }}
        >
          {/* Mobile Heading */}
          ...
          <div className="flex absolute bottom-5 left-1/2 -translate-x-1/2 -translate-y-1/2 md:hidden gap-3">
            {themeColors.map((color, i) => (
              <button
                ...
                className={`w-12 h-12 hover:scale-105 cursor-pointer border-2 rounded-full`}
                style={{
                  backgroundColor: color.primary,
                  borderColor: selectedItem === i ? 'white' : color.secondary
                }}
              ></button>
            ))}
          </div>
...
/>
        ...
        <div className='container lg:h-[100dvh] flex flex-col mx-auto  pb-10'>
          <div className='pt-16 pb-10'>
            <h1 style={{ fontFamily: 'quincycf, sans-serif', color: themeColors[selectedItem].primary }} className='text-center text-4xl lg:text-5xl mb-2'>
              From Cravings Built Without Compromise
            </h1>
        ...
        <div className='container py-14 flex flex-col mx-auto'>
          <div className='flex flex-col-reverse flex-1 px-4 lg:flex-row'>
            <div className='flex-1 flex flex-col justify-center '>
              <h1 style={{ fontFamily: 'quincycf, sans-serif', color: themeColors[selectedItem].primary }} className='text-4xl mb-3'>
                 Meet the Mind Behind Madness
              </h1>
