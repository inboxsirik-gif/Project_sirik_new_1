...
const Termsandcondition = () => {
  return (
    ...
    <div className="max-w-6xl mx-auto  font-sans text-gray-900 pt-30">
      ...
      <section className="mb-10 text-lg md:text-xl leading-relaxed text-justify">
        ...
        <h3 className="text-[16px] md:text-lg font-bold mb-2">1. CHANGES TO WEBSITES CONTENT</h3>
        ...
        <h3 className="text-[16px] md:text-lg font-bold mt-6 mb-2">2. USE OF INFORMSTION AND MATERIALS</h3>
        ...
        <h3 className="text-[16px] md:text-lg font-bold mt-6 mb-2">3. INTELLECTUAL PROPERTY</h3>
        <p className="text-base leading-relaxed text-justify">All material on this website, including but not limited to design, layout, appearance, graphics, and content, is<strong> owned by or licensed to SIRIK Beveraage Pvt. Ltd.</strong> Reproduction is prohibited except as expressly allowed by our copyright notice.<br />
         ...
         <h3 className="text-[16px] md:text-lg font-bold mt-6 mb-2">4. EXTERNAL LINKS</h3>
         <p className="text-base leading-relaxed text-justify">From time to time, our website may include links to other websites for your convenience. We are<strong> not responsible </strong>for the content or accuracy of these external websites.<br />
         ...
         <h3 className="text-[16px] md:text-lg font-bold mt-6 mb-2">5. GOVERNING LAW</h3>
        <p className=" text-base leading-relaxed text-justify">Any dispute arising from the use of our website, purchases from us, or any engagement with us is subject to the <strong>laws of India.</strong> </p>
        <h3 className="text-[16px] md:text-lg font-bold mt-6 mb-2">6. TRANSACTIONS AND PAYMENTS</h3>
        <p className="text-base leading-relaxed text-justify">We are <strong>not liable</strong> for any loss or damage arising from declined payment authorizations, including cases where a cardholder exceeds preset limits agreed with their bank.</p>
        <h3 className="text-[16px] md:text-lg font-bold mt-6 mb-2">7. LIMITATION OF LIABILITY</h3>
        <p className="text-base leading-relaxed text-justify">SIRIK Beveraage Pvt. Ltd. shall not be liable for any indirect, incidental, special, or consequential damages arising from the use of the website or purchase of products.</p>
    </div>
       </div>
       {/* Footer Section */}
