...
import leftimage from '/sirik_left_2.avif'
import rightimage from '/sirik_right_2.avif'
...
const Section_11_2 = () => {
  ...
  return (
    <>
      ...
      <div id="section-11-12" ref={section3Ref}>
        <div className='bg-[#BAD42C] md:h-[100dvh]  flex flex-col mx-auto'>
          <div className=''>
    ...
    <div className="bg-[#FFEFEA] pb-5">
      <div className="flex py-5 items-center justify-center">
        <h1
          ...
          className="text-[#BAD42C] text-3xl lg:text-5xl"
        >
          Not Your No 2.
        </h1>
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="w-full max-w-xl font-semibold mx-auto p-3 flex flex-col items-center justify-center gap-2">
           ...
           <div className='w-full py-2 '>
              <button className="py-4 w-full cursor-pointer rounded-lg bg-[#BAD42C] text-white hover:scale-105 transition-all duration-300 ease-in-out">Add to Cart</button>
           </div>
        </div>
